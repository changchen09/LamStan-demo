				...
				<div class="item" >
                  ...
                  <div class="line">
                     <div class="text hide-s"> 
                        ...
                        <p>"Never underestimate your ability to make someone else's life better- even if you never know it" -Greg Louganis</p>
         ...
         <div id="latest-news">
            <div class="line">
			  ...
			  <div>   <div id="our-work">
               ...
               <div class="tabs">
			   <!--navigation bar starts starts-->
			   
 <?php include("includes/navbar.php"); ?>
<!--navigation bar ends-->
                  <div class="tab-item tab-active">
                    <a class="tab-label active-btn">SCHOOL NEWS</a>
					  <div class="s-12 m-6 l-6">
                  <div class="s-12 l-2">
                    <!--<div class="news-date">
...
Jammu & Kashmir. </p>
                  ...
                  <div class="s-12 m-12 l-5">
                    ...
                    <form class="customform" action="connectivity_feedback.php">
                      ...
                      <div class="s-12 m-12 l-4"><button class="color-btn" name="btn-feedback" type="submit">Submit Button</button></div>
                    </form>
                  </div>                
               </div>
            </div>

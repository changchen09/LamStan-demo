...
{
echo "<script>window.open('login.php'?not_authorizer=you are not authorizd to access !,'_self')</script>";
;
}
		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a index.php?view_posts><i class="glyphicon glyphicon-record"></i> View all posts</a></li>
